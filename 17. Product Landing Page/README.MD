...
<details>
  <summary>📌 Haz clic aquí para leer la nota importante</summary>
  <p>

    Este proyecto es una simulación sencilla realizada con **HTML** y **CSS**, por lo que **no** es un proyecto funcional. 
